...
class BitcoinWalletService {
  ...
  async createPaymentRequest(request: BitcoinPaymentRequest): Promise<BitcoinPaymentResponse> {
    try {
  ...
  async checkPaymentStatus(address: string, expectedAmount: string): Promise<BitcoinTransactionStatus> {
    try {
  ...
  async monitorPayment(
    ...
    onStatusUpdate: (status: BitcoinTransactionStatus) => void,
  ...
  formatBitcoinAmount(btcAmount: string): string {
