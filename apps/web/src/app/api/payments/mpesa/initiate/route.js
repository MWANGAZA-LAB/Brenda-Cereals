...
export async function POST(req) {
    try {
        ...
        if (cleanPhone.startsWith('0')) {
            ...
            return NextResponse.json({ error: 'Invalid phone number format. Use 254XXXXXXXXX, 0XXXXXXXXX, or 7XXXXXXXX' }, { status: 400 });
        }
        ...
        if (mpesaResponse.ResponseCode !== '0') {
            return NextResponse.json({ error: 'Failed to initiate M-Pesa payment', details: mpesaResponse.ResponseDescription }, { status: 500 });
        }
