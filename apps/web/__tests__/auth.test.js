...
const TestWrapper = ({ children }) => {
    ...
    return (_jsx(SessionProvider, { session: null, children: _jsx(QueryClientProvider, { client: queryClient, children: children }) }));
};
describe('Authentication', () => {
    ...
    describe('SignIn Page', () => {
        it('renders the sign in form', () => {
            render(_jsx(TestWrapper, { children: _jsx(SignInPage, {}) }));
