...
const TestWrapper = ({ children }) => {
    ...
    return (_jsx(SessionProvider, { session: mockSession, children: _jsx(QueryClientProvider, { client: queryClient, children: _jsx(CartProvider, { children: children }) }) }));
};
describe('Checkout', () => {
    beforeEach(() => {
        jest.clearAllMocks();
    ...
    describe('Checkout Page', () => {
        it('renders checkout page with authenticated user', () => {
            ...
            render(_jsx(TestWrapper, { children: _jsx(CheckoutPage, {}) }));
